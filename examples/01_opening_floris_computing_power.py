...
fi = FlorisInterface("inputs/curl_farm.yaml")
...
solver_settings = {
    ...
    "flow_field_grid_points": [100, 50, 50],
}
...
fi.reinitialize(wind_directions=[270.], wind_speeds=[8.0], solver_settings=solver_settings)

# Set the yaw angles to 0
# yaw_angles = np.zeros([1,1,2]) # 1 wind direction, 1 wind speed, 2 turbines
fi.calculate_curl_wake()
