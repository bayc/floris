...
y_points = np.arange(500,1500,10.) 
...
x_p = np.array([1000,1000,1000,1500,1500,1500,2000,2000,2000])
y_p = np.array([500,900,1300,500,900,1300,500,900,1300]) 
