...
fig, axarr = plt.subplots(1,3,sharex=True,sharey=True,figsize=(15,3))
font_size = 14
...
for y_idx, yc in enumerate(yaw_combinations):
    ...
    ax1 = axarr[y_idx]
    # ax1.set_title(yc, fontsize=font_size)
    ax1.set_title(titles[y_idx], fontsize=font_size)
    ...
    if y_idx == 0:
        ax1.set_ylabel('Turbine Power (kW)', fontsize=font_size)
    ax1.set_xlabel('Turbines', fontsize=font_size)
...
plt.savefig('5turb_hiTI.png', bbox_inches='tight')
plt.show()
