...
class PowerDensity:
    def __init__(
        self, fi, boundaries, wdir=None, wspd=None, wfreq=None, AEP_initial=None
    ):
        ...
        if AEP_initial is not None:
            ...
            self.AEP_initial = self.fi.get_farm_AEP(self.wdir, self.wspd, self.wfreq)
    ...
    def obj_func(self, varDict):
        ...
        AEP_sum = self.fi.get_farm_AEP(self.wdir, self.wspd, self.wfreq, self.yaw)
