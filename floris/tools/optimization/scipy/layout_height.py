...
class LayoutHeightOptimization(LayoutOptimization):
    ...
    def _set_initial_conditions(self):
        self.x0.append(
            self._norm(
                self.fi.floris.farm.turbines[0].hub_height, self.bndh_min, self.bndh_max
            )
        )
    ...
    def _change_height(self, height):
        ...
        self.fi.reinitialize_flow_field(
            layout_array=((self.fi.layout_x, self.fi.layout_y))
        )

    # Public methods

    def reinitialize_opt_height(
        self,
        boundaries=None,
        height_lims=None,
        wd=None,
        ...
        Args:
            ...
            opt_options (dict, optional): Optimization options used by
                ...
                Defaults to None.
        """
        LayoutOptimization.reinitialize_opt(
            self,
            boundaries=boundaries,
            wd=wd,
            ws=ws,
    ...
    def optimize(self):
        ...
        opt_height = [self._unnorm(opt_results_norm[-1], self.bndh_min, self.bndh_max)]
